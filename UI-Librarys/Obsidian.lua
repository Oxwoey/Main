-- original https://raw.githubusercontent.com/deividcomsono/Obsidian/main/Library.lua
...
local Library = {
    ...
    IsLightTheme = false,
  Scheme = {
    BackgroundColor = Color3.fromRGB(8, 0, 7),
    MainColor = Color3.fromRGB(18, 11, 17),
    AccentColor = Color3.fromRGB(211, 0, 254),
    OutlineColor = Color3.fromRGB(46, 33, 50),
